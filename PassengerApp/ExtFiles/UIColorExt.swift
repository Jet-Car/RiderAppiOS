...
extension UIColor {
    ...
    public struct UCAColor {
        ...
        */
        public static let AppThemeColor = UIColor(hex: 0xff4e00)
        public static let AppThemeColor_Dark = UIColor(hex: 0xcc3e00)
        public static let AppThemeColor_Hover = UIColor(hex: 0xcc3e00)
        public static let AppThemeTxtColor = UIColor(hex: 0xFFFFFF)
        public static let AppThemeStatusBarType = "LIGHT"
        
        public static let AppThemeColor_1 = UIColor(hex: 0x09253b)
        public static let AppThemeColor_1_Hover = UIColor(hex: 0x104167)
        ...
        */
        ...
        public static let appLoginTextFieldBGColor = AppThemeColor
