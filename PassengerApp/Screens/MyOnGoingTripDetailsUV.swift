...
//                    UIApplication.shared.openURL(NSURL(string:"telprompt:" + dataDict.get(Utils.message_str))! as URL)
...
//                    UIApplication.shared.openURL(NSURL(string:"telprompt:" + self.dataDict.get("driverMobile"))! as URL)
                    UIApplication.shared.openURL(NSURL(string: ("telprompt:" + dataDict.get("driverMobile")).addingPercentEncoding(withAllowedCharacters: .urlFragmentAllowed)!)! as URL)
                }
...
//        self.gMapView.moveCamera(GMSCameraUpdate.setCamera(camera))
    ...
    func continueCancelTrip(eConfirmByUser: String){
        ...
        let parameters = ["type":"cancelTrip", "iUserId": GeneralFunctions.getMemberd(), "iDriverId": self.dataDict.get("iDriverId"), "UserType": Utils.appUserType, "iTripId": dataDict.get("iTripId"), "eConfirmByUser": eConfirmByUser]
