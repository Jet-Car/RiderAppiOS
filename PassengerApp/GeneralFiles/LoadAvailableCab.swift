...
//    var currentGeoCodeResult = ""
    ...
    func checkAvailableCabs(){
        ...
        if mainScreenUv != nil
        {
            if mainScreenUv.currentCabGeneralType.uppercased() == Utils.cabGeneralType_UberX.uppercased()
            {
